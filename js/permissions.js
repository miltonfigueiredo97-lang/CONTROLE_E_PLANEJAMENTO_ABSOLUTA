  ...
  const SUBACOES = {
    ...
    controleConcreto: {
      criar:   [ { key: 'bt',          label: 'Lançar BT (boletim de transporte)' },
                 ...
                 { key: 'prancha',     label: 'Adicionar prancha (Planta do Projeto)' },
                 { key: 'marcador',    label: 'Marcar/detectar área na planta' } ],
      editar:  [ { key: 'bt',          label: 'Editar BT lançado' },
                 { key: 'concretagem', label: 'Editar concretagem (BTs, andares)' },
                 { key: 'prancha',     label: 'Renomear/atualizar prancha' },
                 { key: 'marcador',    label: 'Ajustar forma da área marcada' },
                 { key: 'vinculo',     label: 'Vincular área a uma peça' } ],
      excluir: [ { key: 'bt',          label: 'Excluir BT' },
                 { key: 'concretagem', label: 'Excluir concretagem' },
                 { key: 'prancha',     label: 'Excluir prancha' },
                 { key: 'marcador',    label: 'Excluir área marcada' } ],
