...
// importação em lote e configuração de andares.
// Montagem de concretagens (vínculos + BTs) mora
// no Controle de Concreto (controle-concreto.js).
    ...
    c.innerHTML = `
      ...
      <div class="page-header">
        <div>
          ...
          <span class="subtitulo">Base de peças e calculadora de volumes</span>
        </div>
  ...
  function renderCalc() {
    ...
    if (calc.tipoPeca === 'fundacao') {
      ...
      el.innerHTML = `
        ...
        <div style="background:#fff;border:1px solid var(--cor-borda-light);border-radius:8px;padding:10px;margin-bottom:14px;text-align:center;">
          ${esquemaFundacao(calc.tipoFund)}
        </div>
        <div>
          ${camposNomeAndar}
          ${campos}
