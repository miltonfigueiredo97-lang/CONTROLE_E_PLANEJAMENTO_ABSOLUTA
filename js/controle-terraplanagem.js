  ...
  function renderizar() {
    ...
    c.innerHTML = `
      ...
      <div class="cc-kpiGrid" style="grid-template-columns:repeat(auto-fit,minmax(150px,1fr));margin-top:8px;">
        <div class="cc-kpi cc-kpiOrange"><div class="cc-kpiIcon">📦</div><div class="cc-kpiBody"><div class="cc-kpiLabel">Volume de Terra (previsto)</div><div class="cc-kpiValue">${k.volEmpolado > 0 ? TC.fmt1(k.volEmpolado) + '<span class="cc-kpiUnit">m³</span>' : '—'}</div><div class="cc-kpiSub">${k.volEmpolado > 0 ? `+${TC.fmt1(config.taxaEmpolamento * 100)}% empolamento` : 'Sem Levantamento cadastrado ainda'}</div></div></div>
        ...
        <div class="cc-kpi"><div class="cc-kpiIcon">🔩</div><div class="cc-kpiBody"><div class="cc-kpiLabel">Volume Fundação Profunda</div><div class="cc-kpiValue">${k.volEstacasEmpolado > 0 ? TC.fmt1(k.volEstacasEmpolado) + '<span class="cc-kpiUnit">m³</span>' : '—'}</div><div class="cc-kpiSub">${k.volEstacasEmpolado > 0 ? `+${TC.fmt1(config.taxaEmpolamento * 100)}% empolamento` : 'Controle de Estacas'}</div></div></div>
        <div class="cc-kpi"><div class="cc-kpiIcon">🧊</div><div class="cc-kpiBody"><div class="cc-kpiLabel">Volume Fundação Superficial</div><div class="cc-kpiValue">${k.volFundacaoSuperficialEmpolado > 0 ? TC.fmt1(k.volFundacaoSuperficialEmpolado) + '<span class="cc-kpiUnit">m³</span>' : '—'}</div><div class="cc-kpiSub">${k.volFundacaoSuperficialEmpolado > 0 ? `+${TC.fmt1(config.taxaEmpolamento * 100)}% empolamento` : 'Controle de Fundações'}</div></div></div>
      </div>
